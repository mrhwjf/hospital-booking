...
class NhanVienSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('nhan_vien')->upsert([
            [
                'ma_nhan_vien' => 'NV0001',
                'nguoi_dung_id' => $users['nhanvien1@hospital.local'] ?? null,
                'ho_ten' => 'Le Thi Thu',
            ...
            [
                'ma_nhan_vien' => 'NV0002',
                'nguoi_dung_id' => $users['nhanvien2@hospital.local'] ?? null,
        ...
        ], ['nguoi_dung_id'], ['ma_nhan_vien', 'ho_ten', 'so_dien_thoai', 'chuc_vu', 'ngay_vao_lam', 'trang_thai', 'ghi_chu', 'updated_at']);
    }
}